...
class FrontEnd:
    ...
    def responseAnswer(self, questionList, question, answer, cachedEntropyValue, rejected_cards):
        return self.answerProcessor.processAnswer(questionList, question, answer.upper(), rejected_cards, cachedEntropyValue)
