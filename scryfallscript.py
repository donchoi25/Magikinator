...
TEST_SEARCHES = {
    ...
    "Does your card's color identity include red?": "id:r",
    "Does your card's color identity include blue?": "id:u",
    "Does your card's color identity include green?": "id:g",
    "Does your card's color identity include white?": "id:w",
    "Does your card's color identity include black?": "id:b",
    "Can your card be played with an Azorius commander?": "id:azorius",
    "Can your card be played with a Boros commander?": "id:boros",
    "Can your card be played with a Dimir commander?": "id:dimir",
    "Can your card be played with a Golgari commander?": "id:golgari",
    "Can your card be played with a Gruul commander?": "id:gruul",
    "Can your card be played with an Izzet commander?": "id:izzet",
    "Can your card be played with an Orzhov commander?": "id:orzhov",
    "Can your card be played with a Rakdos commander?": "id:rakdos",
    "Can your card be played with a Selesnya commander?": "id:selesnya",
    "Can your card be played with an Abzan commander?": "id:abzan ",
    "Can your card be played with a Bant commander?": "id:bant",
    "Can your card be played with an Esper commander?": "id:esper",
    "Can your card be played with a Grixis commander?": "id:grixis",
    "Can your card be played with a Jeskai commander?": "id:jeskai",
    "Can your card be played with a Jund commander?": "id:jund",
    "Can your card be played with a Mardu commander?": "id:mardu",
    "Can your card be played with a Naya commander?": "id:naya",
    "Can your card be played with a Sultai commander?": "id:sultai",
    "Can your card be played with a Temur commander?": "id:temur",
