...
TEST_SEARCHES = {
    ...
    "Is your card an enchantment that gives creatures vigilance?": "o:'enchanted creature has vigilance'",
    "Is your card an enchantment that gives creatures first strike?": "o:'enchanted creature has first strike'",
    ...
    "Is your card an equipment that can give equipped creature first strike?": "t:equipment and o:'first strike'",
    "Is your card an equipment that can give equipped creature trample?": "t:equipment and o:'trample'",
    "Is your card an equipment that can give equipped creature haste?": "t:equipment and o:'haste'",
    "Is your card an equipment that can give equipped creature flying?": "t:equipment and o:'flying'",
